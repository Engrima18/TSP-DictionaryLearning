...
def plot_error_curves(
    ...
    dict_types = {
        ...
        "sep": "Separated Hodge Laplacian",
        "comp": "Separated Hodge Laplacian and Topology Learning",
    }
...
def plot_learnt_topology(G_true, B2_true, topology1, topology2=None, sub_size=100):
    ...
    try:
        ...
        incidence_mat = [B2_true, topology1.B2]
    ...
    for ax, title in zip(axs, titles):
        ...
        ax.text(
            0.5,
            -0,
            "Number of triangles: {}".format(num_triangles),
            ha="center",
