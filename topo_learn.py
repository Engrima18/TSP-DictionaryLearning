...
def main(cfg: DictConfig):
    ...
    # p_tr = [0.3, 0.5, 0.9, 0.4, 0.2, 0.6]  # [0.3, 0.5, 0.7, 0.9]
    ...
    results_path = f"results/final/{sparsity_mode}_sparsity{K0_max}/tri_learnS{algo_cfg.algo_sparsity}{algo_cfg.algo}{p_tr_name}.pkl"
